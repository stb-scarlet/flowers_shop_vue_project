  ...
  <div class="mobile-navbar">
        ...
        <div class="th-left">
          <ul class="th-settings">
            ...
            <li class="th-language-box" ref="languageList">
              <button class="th-language" @click="toggleLanguage" title="Languages">
                <div class="language-icon">
                  <img src="/action-icons/languages-icon.png" alt="" />
                </div>
              </button>
              <ul class="th-language-list">
                <li class="th-language-item" v-for="lang in ['RU', 'ENG']" :key="lang">
          ...
          <div class="middle-side">
            ...
            <div class="search-bar">
              <div class="search-container">
                <label for="search" class="search-input-container" @click="showSearchView">
                  <input
                    type="text"
                    id="search"
                    class="search-input"
          ...
          <nav class="nav-links" ref="navLinks">
            <ul class="links">
              ...
              <li class="link-container">
                <router-link to="/" exact-active-class="active-link" class="link">Home</router-link>
              </li>
              <!-- Shop Link -->
              <li class="link-container">
                <router-link to="/shop" active-class="active-link" class="link">Shop</router-link>
              </li>
              <!-- About Us Link -->
              <li class="link-container">
                <router-link to="/about-us" active-class="active-link" class="link"
                  >About Us</router-link
                >
              </li>
              <!-- Contact Us Link -->
              <li class="link-container">
                <router-link to="/contact-us" active-class="active-link" class="link"
    ...
    <div class="mobile-bottom-navbar">
      <ul class="actions-container">
        ...
        <!-- Wishlist Page Icon -->
        <li class="action-container">
          <router-link to="/wishlist" class="action" active-class="active-action">
        ...
        <!-- Login Page Button -->
        <li class="action-container">
          <router-link to="/profile" class="action" active-class="active-action">
...
@media (max-width: 1024px) {
  .mobile-navbar {
    ...
    .top-header {
      ...
      background: linear-gradient(to left, rgb(255, 25, 83), rgba(255, 25, 83, 0.7));
      .th-container {
        max-width: 1500px;
      ...
      .actions-container {
        ...
        .action-container {
          ...
          .action {
            ...
            &:hover img {
              filter: invert(36%) sepia(98%) saturate(747%) hue-rotate(86deg) brightness(92%)
                contrast(101%);
            }
