  ...
  <div class="pd-container" v-if="productDetail">
    <div class="pd-actions-container">
      <div class="pda-images-part">
        <div class="pdaip-image-container">
          <img :src="productDetail.src" alt="" />
        </div>
      </div>
            ...
            <div class="mphr-ratings">
              ...
              <span v-for="item in 5" :key="item" class="mphr-star">
                <i
                  ...
                  :style="{
                    color:
                      item <= productStore.getAverageRating(productDetail.reviews) ? 'gold' : '#ccc',
                  }"
                ></i>
              </span>
            </div>
    ...
    <div class="pd-description-reviews">
      ...
      <div class="pddr-container">
        ...
        <div class="reviews" v-if="showReviews">
          <div class="r-card" v-for="review in productDetail.reviews" :key="review">
            ...
            <p>
              ...
              <span
                ><i
                  ...
                  :style="{
                    color:
                      i <= review.rating ? 'gold' : '#ccc',
                  }"
                ></i
              ></span>
            </p>
            <p>Comment: <span>{{ review.comment }}</span></p>
          </div>
        </div>
      </div>
    </div>
