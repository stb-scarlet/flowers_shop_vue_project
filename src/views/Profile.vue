<template>
  <div class="p-container">
    <div class="profile-part">
      <div class="pp-header">
        <div class="ph-update">
          <button class="phub-button" @click="loginRegisterStore.toggleUpdateProfile">
            <i class="fas fa-user-edit"></i>
          </button>
        </div>
        <div class="ph-image">
          <img src="/action-icons/user-icon.svg" alt="" class="ph-not-image" v-if="!loginRegisterStore.currentUser.profileImage">
          <img :src="loginRegisterStore.currentUser.profileImage" alt="" class="ph-image" v-else>
        </div>
        <div class="ph-username">{{ loginRegisterStore.currentUser.username }}</div>
      </div>
      <div class="pp-body">
        ...
        <div class="pb-password">
          <p>Password:</p>
          <p><span v-for="i in loginRegisterStore.currentUser.password.length" :key="i">{{ '*' }}</span></p>
        </div>
      </div>
    </div>
    <TopList />
