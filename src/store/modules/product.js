export default {
    ...
    getters: {
        getProducts: state => {
            return state.products.filter(product => product.plants === true).map((product, index) => {
                if (index % 2 === 0) {
        ...
        getBanners: state => {
            return state.products.filter(product => product.banners === true)
        }
    }
}